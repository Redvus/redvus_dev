$(document).ready(function() {
    ...
    redvus_slogan_tl.from(slogan_V, 2, {opacity: 0, ease:Power1.easeOut}, '-=3')
        .from(slogan_visual, 2, {y: 100, opacity: 0, ease:Power1.easeOut}, '-=0.5')
        .from(slogan_D, 2, {opacity: 0, ease:Power1.easeOut}, '-=0.5')
        .from(slogan_design, 2, {opacity: 0, ease:Power1.easeOut}, '-=0.5')
        .from(slogan_R, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_real, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_E, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_effective, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_U, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_unical, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_S, 2, {opacity: 0, ease:Power1.easeOut})
        .from(slogan_style, 2, {opacity: 0, ease:Power1.easeOut});
